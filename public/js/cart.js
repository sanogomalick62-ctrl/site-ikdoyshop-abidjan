...
const Cart = {
  ...
  // Small "bump" animation on the header cart icon so adding an item feels
  // acknowledged even before the drawer finishes opening.
  bumpIcon() {
    document.querySelectorAll('.icon-btn').forEach(btn => {
      btn.classList.remove('bump');
      void btn.offsetWidth; // restart the animation if it's already mid-way
