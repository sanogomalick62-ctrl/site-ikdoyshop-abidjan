...
const { logActivity, logActivityRaw } = require('../lib/activityLog');
...
router.post('/login', loginLimiter, (req, res) => {
  ...
  logActivityRaw(user.username, user.role, 'auth.login', `s'est connecté`);
...
router.post('/change-password', requireAuth, (req, res) => {
  ...
  logActivity(req, 'auth.password_change', 'a changé son mot de passe');
  res.json({ ok: true });
});
