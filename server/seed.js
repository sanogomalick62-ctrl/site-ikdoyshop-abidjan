...
function seedContent() {
  const defaults = {
    ...
    accent_color: '',
    delivery_info: 'Livraison disponible à Abidjan et dans toute la Côte d\'Ivoire sous 2 à 5 jours ouvrés.',
    payment_info: 'Paiement à la livraison, Orange Money, Wave ou MTN Money — confirmé directement avec vous par téléphone.',
    return_policy: "Échange possible sous 7 jours si la taille ne convient pas, jersey non porté et dans son emballage d'origine."
  };
